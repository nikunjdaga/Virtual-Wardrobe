...
class CollectionsPhotosViewPagerAdapter extends PagerAdapter {
...
//    private List<SavedPhotoUtil> items = new ArrayList<>();
    ...
    public CollectionsPhotosViewPagerAdapter(Context context, Integer positionItemId,
...
//        items = db.getAllPhotoItem(mContext);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View itemView = mLayoutInflater.inflate(R.layout.collections_photos_view_pager, container, false);
