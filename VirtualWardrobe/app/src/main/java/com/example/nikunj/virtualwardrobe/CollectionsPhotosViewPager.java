...
/**
 * Created by nikunj on 12/11/15.
 */

public class CollectionsPhotosViewPager extends AActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            setContentView(R.layout.activity_collections_photos_view_pager);
            dBPositionItemID = extras.getInt("position_for_collection_item");
        ...
        getVariousCollectionsLists();

        CollectionsPhotosViewPagerAdapter mCustomPagerAdapter = new CollectionsPhotosViewPagerAdapter(this,dBPositionItemID,
...
//    JOIN collections ON savedPhoto._collection_name_id = collections._id
//    JOIN colorMain ON savedPhoto._color_main_bracket = colorMain._id
//    WHERE collections._id = 1;

    public void getVariousCollectionsLists(){
...
//        };
        ...
        String selectQuery = "SELECT * FROM " + TABLE_SAVED_PHOTO_UTIL +
                ...
                " WHERE " + TABLE_COLLECTIONS + "." + CollectionsColumns.ID_VALUE + " = " + dBPositionItemID + ";";
