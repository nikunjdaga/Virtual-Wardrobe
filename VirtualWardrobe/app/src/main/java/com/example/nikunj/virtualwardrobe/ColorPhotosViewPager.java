 ...
 */
public class ColorPhotosViewPager extends AActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            setContentView(R.layout.activity_color_photos_view_pager);
            dBPositionItemID = extras.getInt("position_for_color_item");
        ...
        getVariousColorLists();

        ColorPhotosViewPagerAdapter mCustomPagerAdapter = new ColorPhotosViewPagerAdapter(this,dBPositionItemID,
...
//    JOIN collections ON savedPhoto._collection_name_id = collections._id
//    JOIN colorMain ON savedPhoto._color_main_bracket = colorMain._id
//    WHERE colorMain._id = 1;

    public void getVariousColorLists(){
...
//        };
        ...
        String selectQuery = "SELECT * FROM " + TABLE_SAVED_PHOTO_UTIL +
                ...
                " WHERE " + TABLE_COLOR_MAIN + "." + ColorColumns.ID_MAIN_VALUE + " = " + dBPositionItemID + ";";
